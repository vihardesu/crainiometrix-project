...
import { CrainiometrixLogoMinimal } from "@/components/foundations/logo/crainiometrix-logo-minimal";
        ...
        <div className="flex h-dvh flex-col">
            <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-4 md:px-8">
                <div className="relative flex size-28 items-center justify-center">
                    <CrainiometrixLogoMinimal className="size-10" />
                </div>

                <h1 className="max-w-3xl text-center font-display text-display-sm font-semibold text-primary">
                    Crainiometrix care navigator
                </h1>

                <p className="mt-2 max-w-xl text-center text-lg text-tertiary">
                    AI-assisted messaging triage for dementia care navigation teams.
                </p>
